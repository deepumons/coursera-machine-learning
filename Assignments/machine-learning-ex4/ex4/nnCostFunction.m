...
% Expand the 'y' output values into a matrix of single values, i.e. 5000 x 10 matrix
y_matrix = eye(num_labels)(y,:);

% Add bias units to a1
a1 = [ones(m, 1) X];
...
Theta1_grad = Theta1_grad + lambda/m * Theta1_zero_bias;
Theta2_grad = Theta2_grad + lambda/m * Theta2_zero_bias;
